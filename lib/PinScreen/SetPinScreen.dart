  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        body: BlocProvider(create: (context) => PinCubit(),
                          ...
                          child: ListView.separated(scrollDirection: Axis.horizontal,itemBuilder: (context, index) {
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                color: PinCubit.get(context).pinNum.length==index+1||PinCubit.get(context).pinNum.length>index?const Color(0xFF5164BF):null,
